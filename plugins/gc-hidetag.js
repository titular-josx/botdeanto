...
**/
    ...
    const htextos = `${text ? text : '*https://whatsapp.com/channel/0029VajUEsCB4hdNTg04zh1u*'}`;
    if ((isMedia && quoted.mtype === 'imageMessage') && htextos) {
      ...
      await conn.relayMessage(m.chat, {extendedTextMessage: {text: `${masss}\n${htextos}\n`, ...{contextInfo: {mentionedJid: users, externalAdReply: {thumbnail: imagen1, sourceUrl: 'https://whatsapp.com/channel/0029VajUEsCB4hdNTg04zh1u'}}}}}, {});
    }
  }
};
