...
global.dfail = (type, m, conn) => {
  const msg = {
        rowner: '🔮 𝑴𝑰𝑲𝑨𝑺𝑨 𝑩𝑶𝑻 𝙩𝙚 𝙖𝙫𝙞𝙨𝙖 𝙦𝙪𝙚 𝙚𝙨𝙩𝙚 𝙘𝙤𝙢𝙖𝙣𝙙𝙤 𝙨𝙤𝙡𝙤 𝙥𝙪𝙚𝙙𝙚 𝙨𝙚𝙧 𝙪𝙨𝙖𝙙𝙤 𝙥𝙤𝙧 𝙢𝙞 𝙥𝙧𝙤𝙥𝙞𝙚𝙩𝙖𝙧𝙞𝙤',
        owner: '🔮 𝑴𝑰𝑲𝑨𝑺𝑨 𝑩𝑶𝑻 𝙩𝙚 𝙖𝙫𝙞𝙨𝙖 𝙦𝙪𝙚 𝙚𝙨𝙩𝙚 𝙘𝙤𝙢𝙖𝙣𝙙𝙤 𝙨𝙤𝙡𝙤 𝙥𝙪𝙚𝙙𝙚 𝙨𝙚𝙧 𝙪𝙨𝙖𝙙𝙤 𝙥𝙤𝙧 𝙢𝙞 𝙥𝙧𝙤𝙥𝙞𝙚𝙩𝙖𝙧𝙞𝙤',
        mods: '🔮 𝑴𝑰𝑲𝑨𝑺𝑨 𝑩𝑶𝑻 𝙩𝙚 𝙖𝙫𝙞𝙨𝙖 𝙦𝙪𝙚 𝙚𝙨𝙩𝙚 𝙘𝙤𝙢𝙖𝙣𝙙𝙤 𝙨𝙤𝙡𝙤 𝙥𝙪𝙚𝙙𝙚 𝙨𝙚𝙧 𝙪𝙨𝙖𝙙𝙤 𝙥𝙤𝙧 𝙢𝙞 𝙥𝙧𝙤𝙥𝙞𝙚𝙩𝙖𝙧𝙞𝙤',
        premium: '🔮 𝑴𝑰𝑲𝑨𝑺𝑨 𝑩𝑶𝑻 𝙩𝙚 𝙖𝙫𝙞𝙨𝙖 𝙦𝙪𝙚 𝙚𝙨𝙩𝙚 𝙘𝙤𝙢𝙖𝙣𝙙𝙤 𝙨𝙤𝙡𝙤 𝙥𝙪𝙚𝙙𝙚 𝙨𝙚𝙧 𝙪𝙨𝙖𝙙𝙤 𝙥𝙤𝙧 𝙢𝙞 𝙥𝙧𝙤𝙥𝙞𝙚𝙩𝙖𝙧𝙞𝙤',
        group: '🔮 𝑴𝑰𝑲𝑨𝑺𝑨 𝑩𝑶𝑻 𝙩𝙚 𝙖𝙫𝙞𝙨𝙖 𝙦𝙪𝙚 𝙚𝙨𝙩𝙚 𝙘𝙤𝙢𝙖𝙣𝙙𝙤 𝙨𝙤𝙡𝙤 𝙥𝙪𝙚𝙙𝙚 𝙨𝙚𝙧 𝙪𝙨𝙖𝙙𝙤 𝙚𝙣 𝙜𝙧𝙪𝙥𝙤𝙨',
        private: '🔮 𝑴𝑰𝑲𝑨𝑺𝑨 𝑩𝑶𝑻 𝙩𝙚 𝙖𝙫𝙞𝙨𝙖 𝙦𝙪𝙚 𝙚𝙨𝙩𝙚 𝙘𝙤𝙢𝙖𝙣𝙙𝙤 𝙨𝙤𝙡𝙤 𝙥𝙪𝙚𝙙𝙚 𝙨𝙚𝙧 𝙪𝙨𝙖𝙙𝙤 𝙚𝙣 𝙘𝙝𝙖𝙩 𝙥𝙧𝙞𝙫𝙖𝙙𝙤 𝙙𝙚𝙡 𝙗𝙤𝙩',
        admin: '🔮 𝑴𝑰𝑲𝑨𝑺𝑨 𝑩𝑶𝑻 𝙩𝙚 𝙖𝙫𝙞𝙨𝙖 𝙦𝙪𝙚 𝙚𝙨𝙩𝙚 𝙘𝙤𝙢𝙖𝙣𝙙𝙤 𝙨𝙤𝙡𝙤 𝙥𝙪𝙚𝙙𝙚 𝙨𝙚𝙧 𝙪𝙨𝙖𝙙𝙤 𝙥𝙤𝙧 𝙖𝙙𝙢𝙞𝙣𝙨 𝙙𝙚𝙡 𝙜𝙧𝙪𝙥𝙤',
        botAdmin: '🔮 𝑴𝑰𝑲𝑨𝑺𝑨 𝑩𝑶𝑻 𝙩𝙚 𝙖𝙫𝙞𝙨𝙖 𝙦𝙪𝙚 𝙚𝙨𝙩𝙚 𝙘𝙤𝙢𝙖𝙣𝙙𝙤 𝙚𝙡 𝙗𝙤𝙩 𝙙𝙚𝙗𝙚 𝙨𝙚𝙧 𝙖𝙙𝙢𝙞𝙣 𝙙𝙚𝙡 𝙜𝙧𝙪𝙥𝙤 𝙣𝙚𝙘𝙚𝙨𝙖𝙧𝙞𝙖𝙢𝙚𝙣𝙩𝙚',
        unreg: '🔮 𝑴𝑰𝑲𝑨𝑺𝑨 𝑩𝑶𝑻 𝙏𝙀 𝘼𝙑𝙄𝙎𝘼 𝙌𝙐𝙀 𝙉𝙊 𝙀𝙎𝙏𝘼𝙎 𝙍𝙀𝙂𝙄𝙎𝙏𝙍𝘼𝘿𝙊\n\n𝙿𝙰𝚁𝙰 𝚄𝚂𝙰𝚁 𝙴𝚂𝚃𝙴 𝙲𝙾𝙼𝙰𝙽𝙳𝙾 𝙳𝙴𝙱𝙴𝚂 𝚁𝙴𝙶𝙸𝚂𝚃𝚁𝙰𝚁𝚃𝙴, 𝚄𝚂𝙰 𝙴𝙻 𝙲𝙾𝙼𝙰𝙽𝙳𝙾\n➣ .𝘳𝘦𝘨 𝘯𝘰𝘮𝘣𝘳𝘦.𝘦𝘥𝘢𝘥',
